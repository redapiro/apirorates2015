...
angular.module('ratesUiApp').controller('editSchemaDefinitionPostSourceProcessorController', ['$scope', 'configService', '$location',
  'constantsService',
  'storageService',
  'schemaDefinitionHelper',
  function ($scope, configService, $location,
            constantsService, storageService, schemaDefinitionHelper) {
    $scope.editView = 'editSchemaDefinitionPostSourceProcessor';
    //List Rate Schema Definition in Left Column
    $scope.field = 'postSourceProcessors';
    $scope.referenceField = 'postSourceProcessorInsts';
