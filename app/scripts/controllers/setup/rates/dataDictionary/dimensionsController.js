...
angular.module('ratesUiApp')
  .controller('dimensionsController', ['$scope', 'notificationService', 'dataDictionaryService', 'configService', '$location',
    function ($scope, notificationService, dataDictionaryService, configService, $location) {
      $scope.columns = [];
      $scope.datasourceUrl = configService.getHost() + '/config/dictionary/dimensions/search';
