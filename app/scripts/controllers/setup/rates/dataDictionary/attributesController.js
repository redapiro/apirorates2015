...
angular.module('ratesUiApp')
  .controller('attributesController', ['$scope', 'notificationService', 'dataDictionaryService', 'configService', '$location',
    function ($scope, notificationService, dataDictionaryService, configService, $location) {
      $scope.columns = [];
      $scope.datasourceUrl = configService.getHost() + '/config/dictionary/attributes/search';
