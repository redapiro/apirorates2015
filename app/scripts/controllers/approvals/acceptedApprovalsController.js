...
angular.module('ratesUiApp')
  .controller('acceptedApprovalsController', ['$scope', 'notificationService', 'approvalsService', 'configService', '$modal',
    function ($scope, notificationService, approvalsService, configService, $modal) {
      $scope.columns = [];
      $scope.datasourceUrl = configService.getHost() + '/actions/approvals/accepted';
