...
angular.module('ratesUiApp')
  .controller('rateDefImportController', ['$scope', 'rawService', 'feedImportService', 'notificationService', '$modalInstance',
    function ($scope, rawService, feedImportService, notificationService, $modalInstance) {
      ...
      rawService.findRateDefinitions(function (success) {
      ...
      $scope.importFeed = function () {
        ...
        feedImportService.importRateDef($scope.modal.feed.id, $scope.modal.payload, function (data) {
          $scope.modal.inProgress = false;
