      ...
      if (c) {
        for (var d = 0, e = 0; e < this.labels_.length; e++) {
          ...
          "object" == typeof i && (h = ++d, this.yAxes_[h] = {
            series: [f],
            options: i
          }), i || this.yAxes_[0].series.push(f), this.series_[f] = {idx: e, yAxis: h, options: g}
        }
        ...
        this.series_[f] = {
          ...
          yAxis: h,
          options: g
        }, this.yAxes_[h] ? this.yAxes_[h].series.push(f) : this.yAxes_[h] = {series: [f], options: {}}
      }
...
DygraphLayout.prototype.attr_ = function (a) {
  ...
  var b = {
    chart_div: this.dygraph_.graphDiv, reserveSpaceLeft: function (b) {
...
DygraphCanvasRenderer.prototype.attr_ = function (a, b) {
  ...
  var h = this.area;
  a({x: 0, y: 0, w: h.x, h: this.height}), a({x: h.x, y: 0, w: this.width - h.x, h: h.y}), a({
    x: h.x + h.w,
    y: 0,
    w: this.width - h.x - h.w,
    h: this.height
  }), a({x: h.x, y: h.y + h.h, w: this.width - h.x, h: this.height - h.h - h.y})
...
Dygraph.NAME = "Dygraph", Dygraph.VERSION = "1.0.1", Dygraph.__repr__ = function () {
  ...
  var a = this.attr_("showRoller") ? "block" : "none", b = this.plotter_.area, c = {
    position: "absolute",
    zIndex: 10,
    top: b.y + b.h - 25 + "px",
    left: b.x + 1 + "px",
  ...
  for (var e = [], f = 0; f < a.length; ++f) {
    var g = a[f], h = b ? g[1][0] : g[1], i = null === h ? null : DygraphLayout.parseFloat_(h), j = {
      x: 0 / 0,
      y: 0 / 0,
    ...
    if (d("logscale")) {
      ...
      if (n - m >= j / 4) {
        for (var p = n; p >= m; p--) {
          ...
          null === o ? o = {tickValue: q, pixel_coord: r} : Math.abs(r - o.pixel_coord) >= k ? o = {
            tickValue: q,
            pixel_coord: r
          } : s.label = "", l.push(s)
        }
