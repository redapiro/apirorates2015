...
!function (a, b, c) {
  !function (a) {
    "use strict";
    "function" == typeof define && define.amd ? define("datatables", ["../../../../bower_components/jquery/jquery"], a) : "object" == typeof exports ? a(require("jquery")) : jQuery && !jQuery.fn.dataTable && a(jQuery)
  }(function (d) {
    "use strict";
    function e(a) {
    ...
    function l(a, c) {
      var e = Ub.defaults.column, f = a.aoColumns.length, g = d.extend({}, Ub.models.oColumn, e, {
    ...
    function M(a) {
      ...
      if (0 !== l.length)for (var o = k ? 0 : m, p = k ? a.aoData.length : n, r = o; p > r; r++) {
        ...
        1 == a.iDraw && "ajax" == Qb(a) ? w = i.sLoadingRecords : i.sEmptyTable && 0 === a.fnRecordsTotal() && (w = i.sEmptyTable), e[0] = d("<tr/>", {"class": h ? g[0] : ""}).append(d("<td />", {
          valign: "top",
          colSpan: q(a),
    ...
    function W(a) {
      ...
      var j = d("<div/>", {
        ...
        "class": c.sFilter
      }).append(d("<label/>").append(i)), k = function () {
    ...
    function nb(a) {
      ...
      var o = d(m, {"class": g.sScrollWrapper}).append(d(m, {"class": g.sScrollHead}).css({
        ...
        width: c.sXInner || "100%"
      }).append(j.removeAttr("id").css("margin-left", 0).append(b.children("thead")))).append("top" === i ? h : null)).append(d(m, {"class": g.sScrollBody}).css({
        overflow: "auto",
        height: n(f),
        width: n(e)
      }).append(b));
      l && o.append(d(m, {"class": g.sScrollFoot}).css({
        ...
        border: 0,
        width: e ? n(e) : "100%"
      }).append(d(m, {"class": g.sScrollFootInner}).append(k.removeAttr("id").css("margin-left", 0).append(b.children("tfoot")))).append("bottom" === i ? h : null));
    ...
    function xb() {
      if (!Ub.__scrollbarWidth) {
        var a = d("<p/>").css({width: "100%", height: 200, padding: 0})[0], b = d("<div/>").css({
          position: "absolute",
          top: 0,
          left: 0,
          width: 200,
    ...
    function yb(a) {
      ...
      for (d.isArray(l) && o(l), m && l.pre && o(l.pre), o(a.aaSorting), m && l.post && o(l.post), b = 0; b < n.length; b++)for (i = n[b][0], f = k[i].aDataSort, c = 0, e = f.length; e > c; c++)g = f[c], h = k[g].sType || "string", j.push({
        src: i,
        col: g,
        dir: n[b][1],
        index: n[b][2],
    ...
    Ub.Api = Wb = function (a, b) {
      ...
      concat: vc.concat, context: [], each: function (a) {
        ...
        _: function (a, c, e, f, g, h) {
          var i, j, k = a.oClasses, l = a.oLanguage.oPaginate, m = 0, n = function (b, c) {
            ...
            for (f = 0, o = c.length; o > f; f++)if (q = c[f], d.isArray(q)) {
              ...
              }).html(i).appendTo(b), Lb(p, {action: q}, r), m++)
            }
