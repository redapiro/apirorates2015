  ...
  function b(b, d, e, f) {
    ...
    function q(b, c) {
      return b[c - 1] || (b[c - 1] = {
        n: c,
        direction: b == nb ? "x" : "y",
        options: a.extend(!0, {}, b == nb ? hb.xaxis : hb.yaxis)
      }), b[c - 1]
    }
    ...
    function s() {
      ...
      for (c = 0; c < gb.length; ++c) {
        ...
        if (s || (s = [], s.push({x: !0, number: !0, required: !0}), s.push({
            y: !0,
            number: !0,
            required: !0
            ...
            required: !1,
            defaultValue: 0
          }), h.bars.horizontal && (delete s[s.length - 1].y, s[s.length - 1].x = !0)), h.datapoints.format = s), null == h.datapoints.pointsize)for (h.datapoints.pointsize = s.length, j = h.datapoints.pointsize, i = h.datapoints.points, insertSteps = h.lines.show && h.lines.steps, h.xaxis.used = h.yaxis.used = !0, d = e = 0; d < r.length; ++d, e += j) {
          m = r[d];
          var t = null == m;
    ...
    function t(c, d) {
      ...
      return e.className = d, e.width = qb, e.height = rb, c || a(e).css({
        position: "absolute",
        left: 0,
        top: 0
      }), a(e).appendTo(b), fb && (e.width = 2 * qb, e.height = 2 * rb, e.style.width = "" + qb + "px", e.style.height = "" + rb + "px"), e.getContext || (e = window.G_vmlCanvasManager.initElement(e)), e.getContext("2d").save(), fb && e.getContext("2d").scale(2, 2), e
    }
    ...
    function B(b) {
      ...
      l || "full" != f || (f = 5), isNaN(+f) || (h += +f), "x" == b.direction ? (d += h, "bottom" == e ? (pb.bottom += d + g, b.box = {
        top: rb - pb.bottom,
        height: d
      }) : (b.box = {
        top: pb.top + g,
        height: d
      }, pb.top += d + g)) : (c += h, "left" == e ? (b.box = {
        left: pb.left + g,
        width: c
      }, pb.left += c + g) : (pb.right += c + g, b.box = {
        left: qb - pb.right,
        width: c
    ...
    function U(a, b, c) {
      ...
      return h ? (d = h[0], e = h[1], m = gb[d].datapoints.pointsize, {
        datapoint: gb[d].datapoints.points.slice(e * m, (e + 1) * m),
        dataIndex: e,
        series: gb[d],
        seriesIndex: d
      }) : null
    ...
    var fb = window.devicePixelRatio > 1, gb = [], hb = {
      colors: a.flot_color_array || ["#931313", "#638167", "#65596B", "#60747C", "#B09B5B"],
      legend: {
        show: !0,
      ...
      series: {
        ...
        bars: {
          ...
          barWidth: 1,
          fill: !0,
          fillColor: a.flot_bars_fillColor || {colors: [{opacity: .7}, {opacity: 1}]},
          align: "left",
          horizontal: !1
        },
      ...
      hooks: {}
    }, ib = null, jb = null, kb = null, lb = null, mb = null, nb = [], ob = [], pb = {
      left: 0,
      right: 0,
      top: 0,
      bottom: 0
    }, qb = 0, rb = 0, sb = 0, tb = 0, ub = {
      processOptions: [],
      processRawData: [],
      processDatapoints: [],
      drawSeries: [],
    ...
    vb.setData = k, vb.setupGrid = D, vb.draw = I, vb.getPlaceholder = function () {
      ...
      return {
        left: parseInt(nb[m(a, "x") - 1].p2c(+a.x) + pb.left),
        top: parseInt(ob[m(a, "y") - 1].p2c(+a.y) + pb.top)
      }
