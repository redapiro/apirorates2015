...
$(document).ready(function () {
  ...
  if ($("#sales-graph").length && Morris.Area({
      ...
      element: "area-graph",
      data: [{x: "2011 Q1", y: 3, z: 3}, {x: "2011 Q2", y: 2, z: 0}, {x: "2011 Q3", y: 0, z: 2}, {
        x: "2011 Q4",
        y: 4,
        z: 4
      }],
      ...
      element: "bar-graph",
      data: [{x: "2011 Q1", y: 0}, {x: "2011 Q2", y: 1}, {x: "2011 Q3", y: 2}, {x: "2011 Q4", y: 3}, {
        x: "2012 Q1",
        y: 4
      }, {x: "2012 Q2", y: 5}, {x: "2012 Q3", y: 6}, {x: "2012 Q4", y: 7}, {x: "2013 Q1", y: 8}],
      xkey: "x",
      ykeys: ["y"],
      labels: ["Y"],
      ...
      data: [{x: "2011 Q1", y: 3, z: 2, a: 3}, {x: "2011 Q2", y: 2, z: null, a: 1}, {
        x: "2011 Q3",
        y: 0,
        z: 2,
        a: 4
    ...
    var c = [{period: "2012-10-01", licensed: 3407, sorned: 660}, {
      period: "2012-09-30",
      licensed: 3351,
      sorned: 629
      ...
      licensed: 3171,
      sorned: 676
    }, {period: "2012-09-15", licensed: 3201, sorned: 656}, {period: "2012-09-10", licensed: 3215, sorned: 622}];
    Morris.Line({
      element: "year-graph",
      data: c,
      xkey: "period",
  ...
  if ($("#donut-graph").length && Morris.Donut({
      element: "donut-graph",
      data: [{value: 70, label: "foo"}, {value: 15, label: "bar"}, {value: 10, label: "baz"}, {
        value: 5,
    ...
    var f = [{period: "2011 W27", licensed: 3407, sorned: 660}, {
      period: "2011 W26",
      licensed: 3351,
      sorned: 629
  ...
  if ($("#graph-B").length) {
    var g = [{period: "2011-08-12", a: 100}, {period: "2011-03-03", a: 75}, {
      period: "2010-08-08",
      a: 50
    }, {period: "2010-05-10", a: 25}, {period: "2010-03-14", a: 0}, {
      period: "2010-01-10",
      a: -25
    }, {period: "2009-12-10", a: -50}, {period: "2009-10-07", a: -75}, {period: "2009-09-25", a: -100}];
  ...
  if ($("#non-continu-graph").length) {
    var c = [{period: "2012-10-01", licensed: 3407}, {period: "2012-09-30", sorned: 0}, {
      period: "2012-09-29",
      sorned: 618
      ...
      licensed: 3257,
      sorned: null
    }, {period: "2012-09-18", licensed: 3248, other: 1e3}, {period: "2012-09-17", sorned: 0}, {
      period: "2012-09-16",
      sorned: 0
    }, {period: "2012-09-15", licensed: 3201, sorned: 656}, {period: "2012-09-10", licensed: 3215}];
    Morris.Line({
  ...
  if ($("#non-date-graph").length) {
    var c = [{elapsed: "I", value: 34}, {elapsed: "II", value: 24}, {elapsed: "III", value: 3}, {
      elapsed: "IV",
      value: 12
    }, {elapsed: "V", value: 13}, {elapsed: "VI", value: 22}, {elapsed: "VII", value: 5}, {
      elapsed: "VIII",
      value: 26
    }, {elapsed: "IX", value: 12}, {elapsed: "X", value: 19}];
    Morris.Line({
