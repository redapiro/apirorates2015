  ...
  a.fn.noUiSlider = function (c) {
    ...
    function o(b) {
      if (!f(b) && (b = g(b))) {
        ...
        c.children().addClass("noUi-active"), u.on(v.move, {
          ...
          base: b.pass.base,
          handle: c
        }, m), u.on(v.end, {base: b.pass.base, handle: c}, n), a("body").on("selectstart" + t, function () {
          return !1
        })
      }
    }
    ...
    function q(a) {
      if (!f(a) && !a.data.base.find("." + x[4]).length && (a = g(a))) {
        var b, c, d, h = a.pass.base, i = a.pass.handles, j = h.data("style"), l = a["left" === j ? "x" : "y"], m = "left" === j ? h.width() : h.height(), n = {x: a.t[2] ? window.pageXOffset : 0}, o = {
          handles: [],
    ...
    function r() {
      return this.each(function (b, d) {
        ...
        var e, f, g, j, m = a("<div/>").appendTo(d), n = [], r = {
          base: y.base,
        ...
        for (c = a.extend({
          ...
          base: m,
          handle: j
        }, o).on(v.end, {base: m, handle: j}, p), j.data("nui", {
          target: d,
          decimals: g,
          options: c,
          base: m,
    ...
    var t = ".nui", u = a(document), v = {
      start: "mousedown" + t + " touchstart" + t,
      move: "mousemove" + t + " touchmove" + t,
      end: "mouseup" + t + " touchend" + t
    }, w = a.fn.val, x = ["noUi-base", "noUi-origin", "noUi-handle", "noUi-input", "noUi-active", "noUi-state-tap", "noUi-target", "-lower", "-upper", "noUi-connect", "noUi-vertical", "noUi-horizontal", "handles", "noUi-background", "noUi-z-index"], y = {
      base: [x[0], x[13]],
      origin: [x[1]],
      handle: [x[2]]
    }, z = {
